...
// Income represents an income transaction in the Rudra system
type Income struct {
...
type CreateIncomeInput struct {
	...
	Level         int     `json:"level" validate:"required,min=1,max=12"`
...
// IncomeCalculation represents the calculation for Rudra income distribution
...
// DefaultLevelCommissions returns the default commission percentages for 12 levels
func DefaultLevelCommissions() []LevelCommissionConfig {
	...
	return []LevelCommissionConfig{
		...
		{Level: 11, Percentage: 0.25, IsActive: true},
		{Level: 12, Percentage: 0.125, IsActive: true},
	}
}
