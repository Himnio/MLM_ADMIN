    ...
    <div className="space-y-6 animate-fade-in">
      <div className="stat-card">
        ...
        {commissionConfig.length === 0 ? (
          <div className="empty-state"><Settings size={36} /><p>No commission config found</p></div>
        ) : (
          <>
            {/* Mobile cards */}
              ...
              {commissionConfig.map(c => (
                <div key={c.level} className="border border-border rounded-xl p-4">
                  ...
                  <div className="grid grid-cols-2 gap-y-1.5 text-xs">
                    <span className="text-text-muted">Threshold:</span><span className="text-text-primary">{formatCurrency(c.income_amount)}</span>
      ...
      <div className="stat-card">
        ...
        {loading ? (
          ...
          <div className="empty-state"><DollarSign size={36} /><p>Income history data available from member profile</p></div>
        )}
      </div>
